...
public class SingleDataSource implements DataSourceConfigureConstants {
    ...
    private static final String CREATE_DATASOURCE = "CreateDataSource:%s";
    ...
    private void createPool(String name, DataSourceConfigure dataSourceConfigure) {
        try {
            ...
            LOGGER.logTransaction(DalLogType.DATASOURCE_CREATE_DATASOURCE, String.format(CREATE_DATASOURCE, name), message, startTime);
            LOGGER.info(message);
        } catch (Throwable e) {
